    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        ...
        <div class="nk-sidebar-brand">
            ...
            <a href="{{route('admin')}}" class="logo-link nk-sidebar-logo">
                <img class="logo-light logo-img" src="{{asset('logo.png2')}}" srcset="./images/logo2x.png 2x" alt="logo"  height="100px;">
                <img class="logo-dark logo-img" src="{{asset('logo.png2')}}" srcset="./images/logo-dark2x.png 2x" alt="logo-dark"  height="100px;">
            </a>
        </div>
